...
% see the LICENSE file included with this software
    ...
    methods
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            sensor_gains = [1 0.8 1.2 0.8 1];
            u_i(1,:) = ir_distances_wf(1,:) - x; %영점조절 must use distance coordinates with respect to robot's position, not abosolute sensor coordinates
...
%             fprintf('(v,w) = (%0.4g,%0.4g)\n', v,w);
        ...
        function ir_distances_wf = apply_sensor_geometry(obj, ir_distances, state_estimate)
            ...
            ir_distances_wf = ir_distances_wf(1:2,:); %contain coordinates of 5 sensors
        end
