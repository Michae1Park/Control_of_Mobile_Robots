...
% see the LICENSE file included with this software
    ...
    %% METHODS
        ...
        %   See also controller/execute
            ...
            %fprintf('out: %x, %x', outputs.v, outputs.w);
            
            [vel_r, vel_l] = obj.ensure_w(obj.robot, outputs.v, outputs.w);
            %two lines added to check maximum w,v
...
%             fprintf('current_pose: (%0.3f,%0.3f,%0.3f)\n', x, y, theta);
        ...
        function [vel_r, vel_l] = ensure_w(obj, robot, v, w)
            ...
            elseif (vel_rl_min < -obj.robot.max_vel)
                vel_r = vel_r_d - (vel_rl_min + obj.robot.min_vel);
                vel_l = vel_l_d - (vel_rl_min + obj.robot.min_vel);
            else
                vel_r = vel_r_d;
                vel_l = vel_l_d;
            end
